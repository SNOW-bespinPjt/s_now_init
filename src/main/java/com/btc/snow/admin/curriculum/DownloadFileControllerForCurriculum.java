...
@Log4j2
@Controller
public class DownloadFileControllerForCurriculum {

    private static final String DOWNLOAD_DIR = "c:/snow/admin/curriculum";

    @GetMapping("/downloadFromCurriculum")
    public ResponseEntity<Resource> downloadFile(@RequestParam String file, @RequestParam String admin_id) {
